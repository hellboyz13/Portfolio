...
const experiences: TimelineItem[] = [
  {
    ...
    current: true,
    description: [
      'Sole IT support for Singapore HQ, directly supporting 30\u201340 staff including 3 C-level executives and 4 directors across hardware, software, and M365 administration',
      'Oversee 5 APAC site engineers across Vietnam, Indonesia, and China as the regional escalation point',
      'Manage user lifecycle in Entra ID (account creation, licensing, groups, offboarding), administer Exchange Online (mailboxes, DLs, shared mailboxes), and enrol devices through Intune. Monitor endpoint security via Trend Micro',
      'Trained APAC teams on Fresh Service and authored SOPs and user guides for onboarding, offboarding, and equipment requests to standardise workflows across all sites',
      'Drove APAC-wide tech refresh cycles, evaluating end-of-life equipment and coordinating vendor procurement via quotation comparison and Docusign workflows',
    ],
  ...
  },
  {
    ...
    period: '2021 - 2024',
    description: [
      'Led end-to-end deployment of 600+ tablets replacing laptops for 700 staff, covering procurement, configuration, training, and post-deployment support',
      'Provided L1/L2 support for 700+ retail staff across multiple stores, troubleshooting POS systems, RFID, mobile devices, and network infrastructure',
      'Created self-help guides and FAQ documentation that reduced ticket volume by 20% in 2023, freeing team capacity for higher-priority issues',
      'Managed asset inventory of 500+ devices across all locations, tracking hardware lifecycle and coordinating end-of-life refresh programs',
      'Ran monthly onboarding sessions and quarterly training updates, improving first-contact resolution for common IT issues',
    ],
