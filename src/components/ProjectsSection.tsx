...
function RedditBadge({ url }: { url: string }) {
  return (
    ...
    >
      <div className="flex items-center gap-1.5 sm:gap-2.5 px-2.5 sm:px-4 py-1.5 sm:py-2.5 bg-[#FF4500] border-2 border-[#FF4500] rounded-full">
        ...
        <span className="hidden sm:inline text-sm font-bold tracking-wide text-white uppercase">
          Featured on Reddit
        </span>
...
function ProjectCard({ project }: { project: typeof projects[0] }) {
  return (
    <div className="project-card-simple w-full sm:w-[80%] sm:mx-auto">
